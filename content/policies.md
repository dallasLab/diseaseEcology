...
March 10 | 
April 4 | second homework due 
April 30 | third homework due 
May 1 | fourth homework due 
...
This course will be lecture-based, with 4 homework assignments, 2 exams, weekly quizes, and some
attendance/participation points. The laboratory course will complement the lecture material, but grading will be independent (as it is a different course designation). 


## Grading

The total breakdown of points is 500 points. Grades will be assigned using the following weighted components:
